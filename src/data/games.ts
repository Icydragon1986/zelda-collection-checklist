...
const NA: Game[] = [
  ...
  { id: "na-nes-zelda1-classic-gray", title: "The Legend of Zelda – Classic Series (cartouche grise)", console: "NES", region: "NA", year: 1992, category: "reissue", notes: "Réédition commerciale Classic Series avec cartouche grise et nouvelle étiquette (NES-ZL-USA-1), distincte de la cartouche dorée originale." },
  { id: "na-nes-zelda2", title: "Zelda II: The Adventure of Link", console: "NES", region: "NA", year: 1988, category: "main" },
  { id: "na-nes-zelda2-classic-gray", title: "Zelda II: The Adventure of Link – Classic Series (cartouche grise)", console: "NES", region: "NA", year: 1992, category: "reissue", notes: "Réédition commerciale Classic Series avec cartouche grise (NES-AL-USA-1), distincte de la cartouche dorée originale." },
  ...
  { id: "na-snes-alttp-players-choice", title: "A Link to the Past – Player's Choice", console: "SNES", region: "NA", year: 1996, category: "reissue", notes: "Réédition Million Seller / Player's Choice avec étiquette et boîte distinctes. Les changements mineurs de cote ESRB K-A/E ne sont pas séparés ici." },

  { id: "na-gb-la", title: "Link's Awakening", console: "Game Boy", region: "NA", year: 1993, category: "main" },
  { id: "na-gb-la-players-choice", title: "Link's Awakening – Player's Choice", console: "Game Boy", region: "NA", year: 1996, category: "reissue" },
  ...
  { id: "na-n64-oot-players-choice", title: "Ocarina of Time – Player's Choice", console: "Nintendo 64", region: "NA", year: 1999, category: "reissue", notes: "Réédition commerciale à boîte Player's Choice; les révisions de ROM ne sont pas séparées." },
  ...
  { id: "na-gba-alttp-fs-players-choice", title: "A Link to the Past & Four Swords – Player's Choice", console: "Game Boy Advance", region: "NA", year: 2004, category: "reissue" },
  ...
  { id: "na-gc-wind-waker-players-choice", title: "The Wind Waker – Player's Choice", console: "GameCube", region: "NA", year: 2004, category: "reissue", notes: "Réédition commerciale à jaquette Player's Choice; aucune révision interne n'est distinguée." },
  ...
  { id: "na-gc-fs-adventures-cable", title: "Four Swords Adventures – Game Boy Advance Cable Bundle", console: "GameCube", region: "NA", year: 2004, category: "edition", notes: "Coffret officiel comprenant le jeu et un câble Nintendo GameCube–Game Boy Advance." },
  { id: "na-gc-fs-adventures-cable-ca", title: "Four Swords Adventures – Canadian Cable Bundle", console: "GameCube", region: "NA", year: 2004, category: "edition", notes: "Emballage canadien bilingue distinct du coffret américain; jeu et câble inclus." },
  { id: "na-gc-fs-adventures-players-choice", title: "Four Swords Adventures – Player's Choice", console: "GameCube", region: "NA", year: 2005, category: "reissue", notes: "Réédition commerciale à jaquette Player's Choice." },
  ...
  { id: "na-wii-tp-nintendo-selects", title: "Twilight Princess – Nintendo Selects", console: "Wii", region: "NA", year: 2011, category: "reissue", notes: "Réédition commerciale Nintendo Selects à jaquette distincte." },
  ...
  { id: "na-3ds-oot3d-nintendo-selects", title: "Ocarina of Time 3D – Nintendo Selects", console: "Nintendo 3DS", region: "NA", year: 2016, category: "reissue" },
  { id: "na-3ds-albw", title: "A Link Between Worlds", console: "Nintendo 3DS", region: "NA", year: 2013, category: "main" },
  { id: "na-3ds-albw-nintendo-selects", title: "A Link Between Worlds – Nintendo Selects", console: "Nintendo 3DS", region: "NA", year: 2016, category: "reissue" },
  { id: "na-3ds-mm3d", title: "Majora's Mask 3D", console: "Nintendo 3DS", region: "NA", year: 2015, category: "main" },
  { id: "na-3ds-mm3d-nintendo-selects", title: "Majora's Mask 3D – Nintendo Selects", console: "Nintendo 3DS", region: "NA", year: 2019, category: "reissue" },
  ...
  { id: "na-wiiu-wwhd-nintendo-selects", title: "The Wind Waker HD – Nintendo Selects", console: "Wii U", region: "NA", year: 2016, category: "reissue" },
  ...
  { id: "na-switch-botw-explorers", title: "Breath of the Wild – Explorer's Edition", console: "Nintendo Switch", region: "NA", year: 2017, category: "edition", notes: "Jeu physique, guide de 100 pages et carte recto verso; aucun DLC inclus." },
  { id: "na-switch-botw-starter", title: "Breath of the Wild – Starter Pack", console: "Nintendo Switch", region: "NA", year: 2018, category: "edition", notes: "Jeu physique et guide Explorer dans un emballage distinct; sans la carte de l'Explorer's Edition." },
...
const PAL: Game[] = [
  ...
  { id: "pal-snes-alttp-super-classic-fr", title: "A Link to the Past – Super Classic Serie (France)", console: "SNES", region: "PAL", year: 1996, category: "reissue" },
  { id: "pal-snes-alttp-super-classic-de", title: "A Link to the Past – Super Classic Serie (Allemagne)", console: "SNES", region: "PAL", year: 1996, category: "reissue" },
  { id: "pal-snes-alttp-gold-pack-se", title: "A Link to the Past – Gold Pack (Suède)", console: "SNES", region: "PAL", year: 1992, category: "edition", notes: "Coffret suédois Gold Pack à emballage distinct." },

  { id: "pal-gb-la", title: "Link's Awakening", console: "Game Boy", region: "PAL", year: 1993, category: "main" },
  { id: "pal-gb-la-nintendo-classics", title: "Link's Awakening – Nintendo Classics", console: "Game Boy", region: "PAL", year: 1996, category: "reissue" },
  ...
  { id: "pal-gba-minish-cap-adventure-set", title: "The Minish Cap – Limited Edition Adventure Set", console: "Game Boy Advance", region: "PAL", year: 2004, category: "edition" },
  ...
  { id: "pal-gc-wind-waker-players-choice", title: "The Wind Waker – Player's Choice", console: "GameCube", region: "PAL", year: 2004, category: "reissue" },
  ...
  { id: "pal-wii-tp-nintendo-selects", title: "Twilight Princess – Nintendo Selects", console: "Wii", region: "PAL", year: 2011, category: "reissue" },
  ...
  { id: "pal-3ds-oot3d-nintendo-selects", title: "Ocarina of Time 3D – Nintendo Selects", console: "Nintendo 3DS", region: "PAL", year: 2016, category: "reissue" },
  ...
  { id: "pal-3ds-albw-nintendo-selects", title: "A Link Between Worlds – Nintendo Selects", console: "Nintendo 3DS", region: "PAL", year: 2016, category: "reissue" },
  ...
  { id: "pal-wiiu-wwhd-nintendo-selects", title: "The Wind Waker HD – Nintendo Selects", console: "Wii U", region: "PAL", year: 2016, category: "reissue" },
  ...
  { id: "pal-wiiu-hw-limited", title: "Hyrule Warriors – Limited Edition", console: "Wii U", region: "PAL", year: 2014, category: "edition", notes: "Jeu et écharpe bleue dans un coffret européen officiel." },
...
const JP: Game[] = [
  ...
  { id: "jp-3ds-oot3d-happy-price", title: "Toki no Ocarina 3D – Happy Price Selection", console: "Nintendo 3DS", region: "JP", year: 2016, category: "reissue" },
  { id: "jp-3ds-oot3d-fea-double-pack", title: "Toki no Ocarina 3D + Fire Emblem Awakening – Happy Price Double Pack", console: "Nintendo 3DS", region: "JP", year: 2016, category: "reissue", notes: "Coffret japonais réunissant les deux jeux physiques Happy Price Selection." },
  ...
  { id: "jp-wiiu-hw-premium", title: "Hyrule Warriors – Premium Box", console: "Wii U", region: "JP", year: 2014, category: "edition" },
  { id: "jp-wiiu-hw-treasure", title: "Hyrule Warriors – Treasure Box", console: "Wii U", region: "JP", year: 2014, category: "edition" },
  { id: "jp-wiiu-tphd", title: "Twilight Princess HD", console: "Wii U", region: "JP", year: 2016, category: "main" },
  { id: "jp-wiiu-tphd-wolflink", title: "Twilight Princess HD – amiibo Special Edition", console: "Wii U", region: "JP", year: 2016, category: "edition", notes: "Coffret japonais avec amiibo Wolf Link et CD de bande sonore." },
  ...
  { id: "jp-switch-la-artbook", title: "Yume o Miru Shima – Artbook Set", console: "Nintendo Switch", region: "JP", year: 2019, category: "edition" },
